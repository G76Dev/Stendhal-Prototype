// GENERATED AUTOMATICALLY FROM 'Assets/ConfigFiles/Input Master.inputactions'
...
public class @InputMaster : IInputActionCollection, IDisposable
{
    ...
    {
        private @InputMaster m_Wrapper;
        public Combat_MenuActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputMaster m_Wrapper;
        public Enemy_SelectionActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
